...
const CompleteTask = ({ task }) => {
  ...
  return (
    <div className="flex-shrink-0 w-[320px] h-[380px] bg-zinc-900/80 backdrop-blur-md rounded-2xl p-6 flex flex-col justify-between border border-zinc-800 transition-all duration-300 hover:scale-[1.02] hover:border-emerald-500/30 hover:shadow-lg hover:shadow-emerald-500/5">
      <div>
      ...
      <div className="mt-5">
        <div className="w-full py-3 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 font-semibold rounded-xl text-sm flex items-center justify-center gap-2">
